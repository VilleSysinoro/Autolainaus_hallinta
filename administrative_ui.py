...
"color: rgb(255, 255, 255);")
        ...
        self.saveVehiclePushButton.setGeometry(QRect(300, 226, 101, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.vehicleCatalogTableWidget.setGeometry(QRect(10, 270, 931, 241))
        ...
        self.vehiclePictureLabel.setGeometry(QRect(660, 10, 281, 211))
        ...
        self.removeVehiclePushButton.setGeometry(QRect(540, 226, 101, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.notLendablePushButton.setGeometry(QRect(410, 226, 121, 25))
...
"color: rgb(255, 255, 255);")
        ...
        self.printReportPushButton.setGeometry(QRect(750, 80, 61, 23))
...
"background-color: rgb(220, 162, 25);")
        ...
        self.getReportPushButton.setGeometry(QRect(660, 80, 61, 23))
...
"color: rgb(255, 255, 255);")
        ...
        self.vehicleTypeAddFrame = QFrame(self.maintenanceTab)
        self.vehicleTypeAddFrame.setObjectName(u"vehicleTypeAddFrame")
        self.vehicleTypeAddFrame.setGeometry(QRect(10, 10, 471, 481))
        self.vehicleTypeAddFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.vehicleTypeAddFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.vehicleTypeTableWidget = QTableWidget(self.vehicleTypeAddFrame)
        ...
        self.vehicleTypeTableWidget.setGeometry(QRect(10, 100, 441, 271))
        self.vehicleTypeTableWidget.setRowCount(10)
        self.vehicleTypeTableWidget.setColumnCount(1)
        self.vehicleTypeTableWidget.horizontalHeader().setStretchLastSection(True)
        self.vehicleTypeAddLineEdit = QLineEdit(self.vehicleTypeAddFrame)
        self.vehicleTypeAddLineEdit.setObjectName(u"vehicleTypeAddLineEdit")
        self.vehicleTypeAddLineEdit.setGeometry(QRect(10, 60, 331, 22))
        self.vehicleTypeAddPushButton = QPushButton(self.vehicleTypeAddFrame)
        self.vehicleTypeAddPushButton.setObjectName(u"vehicleTypeAddPushButton")
        self.vehicleTypeAddPushButton.setGeometry(QRect(370, 58, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.vehicleTypeDeletePushButton = QPushButton(self.vehicleTypeAddFrame)
        self.vehicleTypeDeletePushButton.setObjectName(u"vehicleTypeDeletePushButton")
        self.vehicleTypeDeletePushButton.setGeometry(QRect(370, 380, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.vehicleTypeAddLable = QLabel(self.vehicleTypeAddFrame)
        self.vehicleTypeAddLable.setObjectName(u"vehicleTypeAddLable")
        self.vehicleTypeAddLable.setGeometry(QRect(20, 20, 111, 16))
        self.reaonsAddFrame = QFrame(self.maintenanceTab)
        self.reaonsAddFrame.setObjectName(u"reaonsAddFrame")
        self.reaonsAddFrame.setGeometry(QRect(490, 10, 461, 481))
        self.reaonsAddFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.reaonsAddFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.reasonAddTableWidget = QTableWidget(self.reaonsAddFrame)
        ...
        self.reasonAddTableWidget.setGeometry(QRect(10, 100, 441, 271))
        self.reasonAddTableWidget.setRowCount(10)
        self.reasonAddTableWidget.setColumnCount(1)
        self.reasonAddTableWidget.horizontalHeader().setStretchLastSection(True)
        self.reasonAddLineEdit = QLineEdit(self.reaonsAddFrame)
        self.reasonAddLineEdit.setObjectName(u"reasonAddLineEdit")
        self.reasonAddLineEdit.setGeometry(QRect(10, 60, 331, 22))
        self.reasonAddPushButton = QPushButton(self.reaonsAddFrame)
        self.reasonAddPushButton.setObjectName(u"reasonAddPushButton")
        self.reasonAddPushButton.setGeometry(QRect(370, 58, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.reasonDeletePushButton = QPushButton(self.reaonsAddFrame)
        self.reasonDeletePushButton.setObjectName(u"reasonDeletePushButton")
        self.reasonDeletePushButton.setGeometry(QRect(370, 380, 75, 24))
...
"color: rgb(255, 255, 255);")
        self.reasonAddLabel = QLabel(self.reaonsAddFrame)
        self.reasonAddLabel.setObjectName(u"reasonAddLabel")
        self.reasonAddLabel.setGeometry(QRect(20, 20, 111, 16))
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.firstNameLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Etunimi, pakollinen tieto</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.firstNameLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
#if QT_CONFIG(tooltip)
        self.lastNameLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Sukunimi, pakollinen tieto</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.lastNameLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
#if QT_CONFIG(tooltip)
        self.vehicleClassLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Ajokorttiluokka, pakollinen tieto</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.vehicleClassLineEdit.setText("")
        self.vehicleClassLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Pakollinen tieto", None))
#if QT_CONFIG(tooltip)
        self.agbRestrictionCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Ajaminen sallitu vain automaattivaihteella, pakollinen tieto</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.agbCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Autossa automaativaihteet, pakollinen tieto", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.vehicleTypeTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Voit poistaa ajoneuvotyypin vailtsemalla sen taulukosta ja painamalla Poista-painiktetta. Jos tyypill\u00e4 on jo ajop\u00e4iv\u00e4kirjamerkintj\u00e4, poistaminen ei ole mahdollista.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.vehicleTypeAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Kirjoita kent\u00e4\u00e4n lis\u00e4tt\u00e4v\u00e4 ajoneuvotyypi ja pain lis\u00e4\u00e4-painiketta. Lis\u00e4\u00e4-painike tulee n\u00e4kyviin kirjoitettuasi kentt\u00e4\u00e4n.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.vehicleTypeAddLable.setText(QCoreApplication.translate("MainWindow", u"Ajoneuvotyypit", None))
#if QT_CONFIG(tooltip)
        self.reasonAddTableWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Voit poistaa ajon tarkoituksen vailtsemalla sen taulukosta ja painamalla Poista-painiktetta. Jos tarkoitus on jo k\u00e4yt\u00f6ss\u00e4, poistaminen ei ole mahdollista.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.reasonAddLineEdit.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Kirjoita kent\u00e4\u00e4n lis\u00e4tt\u00e4v\u00e4 ajon tarkoitus ja pain lis\u00e4\u00e4-painiketta. Lis\u00e4\u00e4-painike tulee n\u00e4kyviin kirjoitettuasi kentt\u00e4\u00e4n.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
