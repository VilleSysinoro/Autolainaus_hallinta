...
# REPLACE enties between << and >> with actual data
...
# General
  ...
  InstallDirRegKey HKCU "Software\<<APPLICATION NAME>>" ""
...
# Language Selection Dialog Settings
  ...
  !define MUI_LANGDLL_REGISTRY_KEY "Software\<<APPLICATION NAME>>" 
...
Section "<<APPLICATION NAME>>" SecProgram
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\UninstallApp.lnk" "$INSTDIR\<<UNINSTALLER NAME>>.exe"
